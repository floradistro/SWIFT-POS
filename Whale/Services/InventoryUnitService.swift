...
final class InventoryUnitService {
    ...
    // MARK: - Package Transfers (Delegated to InventoryTransferService)
    ...
    func createTransfer(
        ...
        try await InventoryTransferService.shared.createTransfer(
            storeId: storeId,
    ...
    func lookupTransfer(qrCode: String, storeId: UUID) async throws -> TransferLookupResult {
        try await InventoryTransferService.shared.lookupTransfer(qrCode: qrCode, storeId: storeId)
    }
    ...
    func receiveTransfer(
        ...
        try await InventoryTransferService.shared.receiveTransfer(
